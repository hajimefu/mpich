...
MPL_STATIC_INLINE_PREFIX fi_addr_t MPIDI_OFI_av_vni_to_phys(MPIDI_av_entry_t * av, int vni_idx)
{
    if (MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS) {
        int rx_idx = vni_idx;
...
MPL_STATIC_INLINE_PREFIX fi_addr_t MPIDI_OFI_comm_vni_to_phys(MPIR_Comm * comm, int rank,
                                                              int vni_idx)
{
    if (MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS) {
        int rx_idx = vni_idx;
