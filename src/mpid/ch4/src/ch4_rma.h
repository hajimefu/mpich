                                       ...
                                       MPIR_Win * win, MPIDI_av_entry_t * av)
{
    ...
    if (transport == MPIDI_CH4R_NETMOD) {
        ...
        if (!cs_acq) {
            ...
            MPIDI_workq_rma_enqueue(PUT, origin_addr, origin_count, origin_datatype, NULL, 0, MPI_DATATYPE_NULL,        /* result addr/count/datatye is used for Get_Acc */
                                    target_rank, target_disp, target_count, target_datatype,
                                    MPI_OP_NULL, NULL, 0, 0, win, av, vni_idx, NULL);
                                       ...
                                       MPIR_Win * win, MPIDI_av_entry_t * av)
{
    ...
    if (transport == MPIDI_CH4R_NETMOD) {
        ...
        if (!cs_acq) {
            ...
            MPIDI_workq_rma_enqueue(GET, NULL, 0, MPI_DATATYPE_NULL, origin_addr, origin_count,
                                    origin_datatype, target_rank, target_disp, target_count,
                                    target_datatype, MPI_OP_NULL, NULL, 0, 0, win, av, vni_idx,
                                    NULL);
            mpi_errno = MPI_SUCCESS;
        } else {
